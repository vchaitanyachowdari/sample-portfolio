                  ...
                  >
                    <Flex fillWidth horizontal="space-between" vertical="end">
                      ...
                      <Text
                        ...
                        onBackground="neutral-weak"
                      >
                        {institution.timeframe} {/* Display the timeframe */}
                      </Text>
                    </Flex>
                    <Text
                      variant="heading-default-xs"
                      ...
                      {skill.items &&
                        skill.items.map((item, itemIndex) => (
                          <Flex
                            ...
                            marginTop="4"
                          >
                            <Icon name={item.icon} size="l" opacity={50} />{" "}
                            {/* Render the icon */}
                            <Text
                              variant="body-default-m"
                              onBackground="neutral-weak"
            ...
            <>
              ...
              <Column fillWidth gap="l" marginBottom="40">
                {about.certifications.items.map((certification, index) => (
                  ...
                  >
                    ...
                    >
                      <Flex vertical="center" gap="8">
                        <Icon name={certification.icon} size="m" />
                        <Text
              ...
              {about.certifications.more && (
                <Flex horizontal="center" marginTop="s">
                  <Button
                    href={about.certifications.more}
                    variant="secondary"
                    size="m"
                    suffixIcon="openLink"
                  >
