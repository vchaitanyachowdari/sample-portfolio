---
title: Crafting your own AI chat app using Hilla and Spring AI
publishedAt: "2023-11-22"
tags: ['spring', 'hilla', 'ai']
draft: false
summary: Creating a chat app using Hilla and Spring AI to interact with an OenAI or Azure OpenAI service. The tutorial covers the use of Hilla components for UI and Spring AI for AI integration.
image: https://cdn-images-1.medium.com/max/2000/1*dTELupDEJJUGzL04rUiD4g.png
---
