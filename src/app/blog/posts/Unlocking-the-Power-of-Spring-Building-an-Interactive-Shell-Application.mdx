---
title: "Unlocking the Power of Spring: Building an Interactive Shell Application"
publishedAt: "2023-05-27"
tags: ['Spring', 'Shell', 'shell-app']
draft: false
summary:  "Creating shell applications using spring shell and converting them to native executables using graalvm. A shell app can be used to automate processes, setting up config etc."
image: https://cdn-images-1.medium.com/max/2400/1*FpSQgp4Wks6k8rCrhB7iWA.png
---
