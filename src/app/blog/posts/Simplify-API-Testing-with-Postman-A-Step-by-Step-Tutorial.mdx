---
title: "Simplify API Testing with Postman: A Step-by-Step Tutorial"
publishedAt: "2023-07-06"
tags: ['Postman', 'Testing', 'API', 'Postman']
draft: false
summary:  "A comprehensive guide to API testing with Postman. Here we are using postman to test the API's provided by Spotify. "
image: https://cdn-images-1.medium.com/max/2400/0*UfeVp1js5Mcgha5X
---

![Photo by [Sigmund](https://unsplash.com/@sigmund?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)](https://cdn-images-1.medium.com/max/9606/0*UfeVp1js5Mcgha5X)
...
Here we are assuming that you have already installed Postman on your system. If you haven’t done so, please visit [https://www.postman.com/](https://www.postman.com/) to download the latest version of Postman and follow the installation instructions.

Now, let’s begin by heading over to [https://developer.spotify.com/](https://developer.spotify.com/). If you don’t have a Spotify account, you can create a free account. After logging in, navigate to the “Documentation” tab and select “Web API” to access the Spotify API documentation.

![](https://cdn-images-1.medium.com/max/3788/1*CL0ELx4nssmwjB2E8ZcUNQ.png)

Now let's first go ahead and create a simple Spotify app.

Steps :

 1. On the Spotify API documentation page, click on “Getting started.”

![](https://cdn-images-1.medium.com/max/2000/1*UA1vHovl6ABm9eany1Inww.jpeg)

2. Next, click on “Create App.”

![](https://cdn-images-1.medium.com/max/2000/1*2gsrzC4ybCE2-4bix_R9SA.jpeg)

3. You will be redirected to the app dashboard URL.

![](https://cdn-images-1.medium.com/max/2000/1*uXF3eYFLbaq5VASkYDVXCQ.jpeg)

4. Once the dashboard opens, click on “Create app.”

![](https://cdn-images-1.medium.com/max/2000/1*y3-hltAtRknWw1Fwr367ag.jpeg)
...
![](https://cdn-images-1.medium.com/max/3794/1*Codb1z26_SwYmVd-VIUl4w.png)
...
![](https://cdn-images-1.medium.com/max/2014/1*Ohrp_SyMiTyGf6strKHQEA.png)

Something like this 

![](https://cdn-images-1.medium.com/max/3800/1*-xls-vVVLpVVwlgGx2dRog.png)
...
![](https://cdn-images-1.medium.com/max/2240/1*fpyC0w2rvc0wYOMlBXHVLw.png)

Once the workspace is created, let's import a new request by clicking on import as shown below :

![](https://cdn-images-1.medium.com/max/2240/1*SPO1IJR0UyrIRLHn12gV1Q.png)
...
```
![](https://cdn-images-1.medium.com/max/2240/1*H01WRwNqaVxo4BiufWI8MQ.png)
...
![](https://cdn-images-1.medium.com/max/3794/1*jtNVqaIjWGNkC_jPrIRvjA.png)
...
![](https://cdn-images-1.medium.com/max/3812/1*okbUk_YWsTxnCy8J1jm7CQ.png)
...
![](https://cdn-images-1.medium.com/max/2240/1*r-6LuA_H4o1oOhwlOBkQ3w.png)

Click on ADD.

![](https://cdn-images-1.medium.com/max/2240/1*IZOMADdsY6cU8ERqbLKbdg.png)

Assign a name to the environment, for example, “Test spotify” and press the enter key.

![](https://cdn-images-1.medium.com/max/2658/1*4ERIwXZ___ItggkOcr015Q.png)
...
![](https://cdn-images-1.medium.com/max/2678/1*FzjxV6US9i2GVXPVPDo7LA.png)
...
![](https://cdn-images-1.medium.com/max/3788/1*NINt_zcpqOsVzfKn_yaU1w.png)
...
![](https://cdn-images-1.medium.com/max/2616/1*LbgGDGntWUpLU7ndmvc4MQ.png)
...
For more info Refer to Spotify documentation here: *S[earch](https://developer.spotify.com/documentation/web-api/reference/search)*
...
![](https://cdn-images-1.medium.com/max/2558/1*O6B-5U8MZjtu-9RmUpXhug.png)

Now send the request and it will return all the data from Spotify in the below given JSON format :

![](https://cdn-images-1.medium.com/max/2514/1*ySXYSuTYddSqORzuGiCUXQ.png)
...
![](https://cdn-images-1.medium.com/max/2564/1*apeadRaBXPuSvXjfR_Z8jQ.png)

Now send the request and it will return you the Spotify catalog information about an artist’s albums.

*If you want to try other APIS you can check out the official documentation from Spotify[ here.](https://developer.spotify.com/documentation/web-api/reference)*
...
To perform this test, follow these steps:
 ...
 1. Open Postman and select the API you want to test.

 2. Navigate to the “Tests” tab for that particular request.

 3. Write the following test script:
...
![](https://cdn-images-1.medium.com/max/2564/1*hHM0hkhgd60ORJB75chhzg.png)
